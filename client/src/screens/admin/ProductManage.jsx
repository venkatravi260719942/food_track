...
import ProductTableView from "./Product_table_view";
import ProductPhotoView from "./Product_photo_view";
...
const FontAwesomeTrashIcon = styled(FontAwesomeIcon)(({ theme }) => ({
  cursor: "pointer",
  color: "black",
}));
...
function ProductManage() {
  ...
  // Function to toggle between table and photo view
    ...
    <div className="product_page">
      ...
      <div className="search_and_buttons">
        ...
        <div className="search_content">
          ...
          {viewProduct !== "table" &&
            (selectedProductsToDelete.length <= 0 ? (
              ...
              <ProductDeSelectAll onClick={handleDeselectAll}>
          ...
          {selectedProductsToDelete.length !== 0 && (
            <ProductDeleteButton
              ...
              data-testid="deleteb"
            >
              <FontAwesomeTrashIcon icon={faTrash} size="s" />
        ...
        <div className="view_buttons">
          ...
          <ProductTableButton style={{}} data-testid="pview">
            <StyledFontAwesomeIconCell
              icon={faList}
              onClick={productToggleView}
              data-testid="ptview"
