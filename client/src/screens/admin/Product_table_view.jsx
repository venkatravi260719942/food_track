...
import "../../styles/Product_table_view.css";
...
const StyledDataGridProductTable = styled(DataGrid)(({ theme }) => ({
  borderRadius: "5px",
...
function Product_table_view({
  ...
  const handleRowClick = (params) => {
    navigate(`/admin/edit_product/${params.id}`);
  };
  ...
  return (
    <div className="producttable" style={{ height: "80vh", width: "100%" }}>
      <ToastContainer />
      <style>
        {`
          .header-grey {
      ...
      <div className="producttable_header" style={{ height: "100%" }}>
        {productsWithCategory.length > 0 ? (
          <StyledDataGridProductTable
...
export default Product_table_view;
